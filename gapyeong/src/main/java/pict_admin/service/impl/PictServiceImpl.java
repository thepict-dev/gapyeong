...
//	private PictDAO pictDAO;
	...
	@Override
	public List<?> board_list_latest(PictVO pictVO) throws Exception {
		return pictMapper.board_list_latest(pictVO);
	}

	@Override
	public void bill_insert(PictVO pictVO) throws Exception {
		pictMapper.bill_insert(pictVO);
	}

	@Override
	public PictVO bill_select(PictVO pictVO) throws Exception {
		// TODO Auto-generated method stub
		return pictMapper.bill_select(pictVO);
	}
	
	@Override
	public void bill_update(PictVO pictVO) throws Exception {
		pictMapper.bill_update(pictVO);
	}

	@Override
	public List<PictVO> test_list(PictVO pictVO) throws Exception {
		// TODO Auto-generated method stub
		return pictMapper.test_list(pictVO);
	}
	
	@Override
	public PictVO test_list_one(PictVO pictVO) throws Exception {
		// TODO Auto-generated method stub
		return pictMapper.test_list_one(pictVO);
	}

	@Override
	public List<PictVO> non_list(PictVO pictVO) throws Exception {
		return pictMapper.non_list(pictVO);
	}

	@Override
	public List<PictVO> confirm_num_list(PictVO pictVO) throws Exception {
		return pictMapper.confirm_num_list(pictVO);
	}

	@Override
	public void confirm_update(PictVO pictVO) throws Exception {
		pictMapper.confirm_update(pictVO);
	}

	@Override
	public PictVO select_user(PictVO vo) throws Exception {
		return pictMapper.select_user(vo);
	}

	@Override
	public void insert_user_info(PictVO pictVO) throws Exception {
		pictMapper.insert_user_info(pictVO);
	}

	@Override
	public void update_user_info(PictVO pictVO) throws Exception {
		pictMapper.update_user_info(pictVO);
	}

	@Override
	public List<PictVO> non_hospital(PictVO pictVO) throws Exception {
		// TODO Auto-generated method stub
		return pictMapper.non_hospital(pictVO);
	}

	@Override
	public PictVO test_user_one(PictVO pictVO) throws Exception {
		return pictMapper.test_user_one(pictVO);
	}

	@Override
	public List<PictVO> test_user_list(PictVO pictVO) throws Exception {
		return pictMapper.test_user_list(pictVO);
	}

	@Override
	public PictVO center_get_user_info(PictVO pictVO) throws Exception {
		return pictMapper.center_get_user_info(pictVO);
	}

	@Override
	public void center_address_update(PictVO pictVO) throws Exception {
		pictMapper.center_address_update(pictVO);
	}

	@Override
	public void center_address_insert(PictVO pictVO) throws Exception {
		pictMapper.center_address_insert(pictVO);
	}

	@Override
	public PictVO user_bill_accept(PictVO pictVO) throws Exception {
		// TODO Auto-generated method stub
		return pictMapper.user_bill_accept(pictVO);
	}

	@Override
	public List<PictVO> user_bill_list(PictVO pictVO) throws Exception {
		// TODO Auto-generated method stub
		return pictMapper.user_bill_list(pictVO);
	}

	@Override
	public PictVO bill_info(PictVO pictVO) throws Exception {
		// TODO Auto-generated method stub
		return pictMapper.bill_info(pictVO);
	}

	@Override
	public List<PictVO> bill_img_list(PictVO pictVO) throws Exception {
		// TODO Auto-generated method stub
		return pictMapper.bill_img_list(pictVO);
	}

	@Override
	public void bill_print(PictVO pictVO) throws Exception {
		pictMapper.bill_print(pictVO);
	}

	@Override
	public Map<String, Object> print_person(PictVO pictVO) throws Exception {
		List<?> result = pictMapper.print_person(pictVO);
