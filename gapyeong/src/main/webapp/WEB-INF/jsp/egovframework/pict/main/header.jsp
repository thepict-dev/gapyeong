...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="/images/pict/favicon.png">
	...
	<!-- 
	<script async src="https://www.googletagmanager.com/gtag/js?id=G-E8J0MLQY78"></script>
	<script>
		window.dataLayer = window.dataLayer || [];
		function gtag(){dataLayer.push(arguments);}
		gtag('js', new Date());
		
		gtag('config', 'G-E8J0MLQY78');
	</script>
	 -->
</head>     
